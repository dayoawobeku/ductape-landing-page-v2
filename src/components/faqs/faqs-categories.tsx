  ...
  return (
    <div className="space-y-8 px-6 md:px-0">
      {categories.map((category) => (
        <div key={category.id} className=" pb-4 flex w-full items-start flex-col md:flex-row">
          <div
            
            className="flex justify-between items-center w-full text-left py-4 lg:w-2/4"
          >
            ...
            <div className="mt-4 space-y-4 w-full lg:w-3/4">
